...
@Component({
  selector: 'app-new-sale-earthlink',
  templateUrl: './new-sale-earthlink.component.html',
  styleUrl: './new-sale-earthlink.component.css',
})
export class NewSaleEarthlinkComponent implements OnInit, OnDestroy {
  agentNames: string[] = [];
  ...
  restoreTabState(): void {
    if (this.tabStateService.hasState('earthlink', 'earthlink/new-sale')) {
  ...
  saveTabState(): void {
    this.tabStateService.setState('earthlink', 'earthlink/new-sale', this.atntSaleInput);
  }
