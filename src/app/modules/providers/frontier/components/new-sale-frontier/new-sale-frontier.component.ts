...
@Component({
  selector: 'app-new-sale-frontier',
  templateUrl: './new-sale-frontier.component.html',
  styleUrl: './new-sale-frontier.component.css',
})
export class NewSaleFrontierComponent implements OnInit, OnDestroy {
  agentNames: string[] = [];
  ...
  restoreTabState(): void {
    if (this.tabStateService.hasState('frontier', 'frontier/new-sale')) {
